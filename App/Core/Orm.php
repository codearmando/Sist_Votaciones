...
class Orm
{
    ...
    public function getSelectIDParams($parameters = null, $condition = null, $condition2 = null, $valor = null, $valor2 = null)
    {
        if ($parameters != null && $condition != null && $condition2 != null && $valor != null && $valor2 != null) {
            $sql = "SELECT $parameters FROM {$this->table} WHERE $condition = :dato AND $condition2 = :dato2 ";
            $stm = $this->bd->prepare($sql);
    ...
    public function getSelectIDParameters($parameters = null, $condition = null, $condition2 = null, $condition3 = null, $valor = null, $valor2 = null, $valor3 = null)
    {
        if ($parameters != null && $condition != null && $condition2 != null && $condition3 != null && $valor != null && $valor2 != null && $valor3 != null) {
            $sql = "SELECT $parameters FROM {$this->table} WHERE $condition = :dato AND $condition2 = :dato2 AND $condition3 = :dato3 ";
            $stm = $this->bd->prepare($sql);
            $stm->bindValue(":dato", $valor);
            $stm->bindValue(":dato2", $valor2);
            $stm->bindValue(":dato3", $valor3);
            $stm->execute();
            return $stm->fetch();
        }
    }
