...
export const AxiosPost = async (url,obj_data,dataname,title,msms,tableData) => {
...
export const AxiosConfitVotar = (url,obj_data,dataname,text,textbtn,title,msms,tableData) => {
  try {
        ...
        if (tableData != null) {
          ...
          if (resp.status == 200 && resp.statusText == 'OK') {
            ...
            if(resp_data == 2){
              ...
              Swal.fire(
                'Error de Emergencia!',
                'Esta intentando realizar una de un registro que no existente o no se encuentra en la data.',
                'warning'
              )
            }
            tableData()
